...
MEM_0 := qsys_epcs_flash_controller_0_boot_rom
...
$(MEM_2)_START := 0x20000000
$(MEM_2)_END := 0x207fffff
...
$(MEM_3)_START := 0x20800000
$(MEM_3)_END := 0x20ffffff
$(MEM_3)_SPAN := 0x00800000
$(MEM_3)_HIERARCHICAL_PATH := sdram_1
$(MEM_3)_WIDTH := 32
...
.PHONY: sdram_1
sdram_1: check_elf_exists $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
