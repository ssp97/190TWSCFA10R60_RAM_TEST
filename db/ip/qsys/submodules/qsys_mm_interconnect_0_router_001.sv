...
(
    ...
    localparam PAD3 = log2ceil(64'h10008000 - 64'h10000000); 
    localparam PAD4 = log2ceil(64'h20800000 - 64'h20000000); 
    localparam PAD5 = log2ceil(64'h21000000 - 64'h20800000); 
    // -------------------------------------------------------
    ...
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 30'h20800000   ) begin
