...
module unsaved_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> ram_s1_agent:cp_data
	...
	wire          cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> sdram_0_s1_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> sdram_0_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                       // sdram_0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> sdram_0_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> sdram_0_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> sdram_0_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> sdram_1_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> sdram_1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                       // sdram_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> sdram_1_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> sdram_1_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> sdram_1_s1_agent:cp_endofpacket
	...
	wire  [105:0] ram_s1_agent_rp_data;                                                        // ram_s1_agent:rp_data -> router_005:sink_data
	...
	wire          sdram_0_s1_agent_rp_valid;                                                   // sdram_0_s1_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] sdram_0_s1_agent_rp_data;                                                    // sdram_0_s1_agent:rp_data -> router_007:sink_data
	wire          sdram_0_s1_agent_rp_ready;                                                   // router_007:sink_ready -> sdram_0_s1_agent:rp_ready
	wire          sdram_0_s1_agent_rp_startofpacket;                                           // sdram_0_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          sdram_0_s1_agent_rp_endofpacket;                                             // sdram_0_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          sdram_1_s1_agent_rp_valid;                                                   // sdram_1_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] sdram_1_s1_agent_rp_data;                                                    // sdram_1_s1_agent:rp_data -> router_008:sink_data
	wire          sdram_1_s1_agent_rp_ready;                                                   // router_008:sink_ready -> sdram_1_s1_agent:rp_ready
	wire          sdram_1_s1_agent_rp_startofpacket;                                           // sdram_1_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          sdram_1_s1_agent_rp_endofpacket;                                             // sdram_1_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire    [6:0] cmd_demux_001_src3_channel;                                                  // cmd_demux_001:src3_channel -> cmd_mux_006:sink1_channel
	...
	wire    [6:0] rsp_demux_006_src1_channel;                                                  // rsp_demux_006:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire          sdram_0_s1_agent_rdata_fifo_src_valid;                                       // sdram_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] sdram_0_s1_agent_rdata_fifo_src_data;                                        // sdram_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          sdram_0_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_005:in_0_ready -> sdram_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> sdram_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> sdram_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                           // sdram_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> sdram_0_s1_agent:rdata_fifo_sink_error
	wire          sdram_1_s1_agent_rdata_fifo_src_valid;                                       // sdram_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] sdram_1_s1_agent_rdata_fifo_src_data;                                        // sdram_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          sdram_1_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_006:in_0_ready -> sdram_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                           // avalon_st_adapter_006:out_0_valid -> sdram_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                            // avalon_st_adapter_006:out_0_data -> sdram_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                           // sdram_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                           // avalon_st_adapter_006:out_0_error -> sdram_1_s1_agent:rdata_fifo_sink_error
	...
	unsaved_mm_interconnect_0_router_004 router_008 (
