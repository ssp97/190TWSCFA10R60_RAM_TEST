...
module qsys_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [108:0] epcs_flash_controller_0_epcs_control_port_agent_rf_source_data;              // epcs_flash_controller_0_epcs_control_port_agent:rf_source_data -> epcs_flash_controller_0_epcs_control_port_agent_rsp_fifo:in_data
	...
	wire  [108:0] epcs_flash_controller_0_epcs_control_port_agent_rsp_fifo_out_data;           // epcs_flash_controller_0_epcs_control_port_agent_rsp_fifo:out_data -> epcs_flash_controller_0_epcs_control_port_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> epcs_flash_controller_0_epcs_control_port_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // epcs_flash_controller_0_epcs_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> epcs_flash_controller_0_epcs_control_port_agent:cp_channel
	...
	wire  [107:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> ram_s1_agent:cp_data
	...
	wire  [107:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> sdram_0_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                       // sdram_0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> sdram_0_s1_agent:cp_channel
	...
	wire  [108:0] sdram_1_s1_agent_rf_source_data;                                             // sdram_1_s1_agent:rf_source_data -> sdram_1_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] sdram_1_s1_agent_rsp_fifo_out_data;                                          // sdram_1_s1_agent_rsp_fifo:out_data -> sdram_1_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> sdram_1_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                       // sdram_1_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> sdram_1_s1_agent:cp_channel
	...
	wire  [107:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [107:0] epcs_flash_controller_0_epcs_control_port_agent_rp_data;                     // epcs_flash_controller_0_epcs_control_port_agent:rp_data -> router_005:sink_data
	...
	wire  [107:0] sdram_0_s1_agent_rp_data;                                                    // sdram_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [107:0] sdram_1_s1_agent_rp_data;                                                    // sdram_1_s1_agent:rp_data -> router_009:sink_data
	...
	qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (epcs_flash_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (epcs_flash_controller_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
